...
public class AjoutProduitTest extends BaseSeleniumTest {
    ...
    public void testAccesPageCreation() {
        ...
        driver.findElement(By.name("dateExpiration")).sendKeys("2025-12-31"); // Format YYYY-MM-DD pour input
                                                                              // type="date"
        ...
        // Vérifier que nous ne sommes plus sur la page de création et pas sur une page
        // d'erreur
